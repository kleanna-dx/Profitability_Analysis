#!/usr/bin/env python3
"""
21.xlsx -> bw_profitability_data 추가 적재 (INSERT only, 기존 데이터 유지)
"""
import time
import gc
import pymysql
...
XLSX_PATH = '/home/user/uploaded_files/21.xlsx'
BATCH_SIZE = 300

def main():
    print("[적재] 21.xlsx -> bw_profitability_data 추가 INSERT 시작")
