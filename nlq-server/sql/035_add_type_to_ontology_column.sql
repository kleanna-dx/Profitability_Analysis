-- ============================================================
-- Migration: 035_add_type_to_ontology_column.sql
...
--
-- Note:
--   MariaDB 에서 `type` 은 예약어(RESERVED)가 아니라 비예약 키워드(NON-RESERVED)
--   이므로 컬럼명으로 사용 가능하며 백틱 없이 SELECT/UPDATE 가능.
-- ============================================================
...
CREATE INDEX idx_ontology_type ON ontology_column(type);
